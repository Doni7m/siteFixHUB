  ...
  return (
    <>
      ...
      <video 
        ...
        playsInline
      >
        <source src="https://res.cloudinary.com/doxbp6clc/video/upload/v1740764827/20250228_1743_Dynamic_Tool_Animation_remix_01jn6tfjqbe5atas3g7g117veq_ch5wdw.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video>
